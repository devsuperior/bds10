package com.devsuperior.bds10.controllers;
...
import com.devsuperior.bds10.dto.DepartmentDTO;
import com.devsuperior.bds10.dto.EmployeeDTO;
import com.devsuperior.bds10.tests.TokenUtil;
...
public class EmployeeControllerIT {
	...
	public void insertShouldReturn422WhenAdminLoggedAndBlankName() throws Exception {
		...
		EmployeeDTO dto = new EmployeeDTO(null, "   ", "joaquim@gmail.com", new DepartmentDTO(1L, ""));
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndInvalidEmail() throws Exception {
		...
		EmployeeDTO dto = new EmployeeDTO(null, "Joaquim", "joaquim@", new DepartmentDTO(1L, ""));
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndNullDepartment() throws Exception {
		...
		result.andExpect(status().isUnprocessableEntity());
		result.andExpect(jsonPath("$.errors[0].fieldName").value("department"));
		result.andExpect(jsonPath("$.errors[0].message").value("Campo requerido"));
	}
}
